        ...
        <div class="row">
            <div class="col-lg-6 sav-info">
                ...
                <form method="POST" name="form" class="sav-form" action="historique.php" enctype="multipart/form-data" onsubmit="return validateForm()">
                    Numéro<input type="text" name="num" placeholder="Numéro" id="num" value="22193299">
                    Nom<input type="text" name="nom" placeholder="Nom" id="nom" value="achour">
                    Prénom<input type="text" name="prenom" placeholder="Prénom" id="prenom" value="hatem">
                    Adresse<input type="text" name="adress" placeholder="Adresse" id="adress" value="Ariana">
                    Date de Naissance<input name="date" placeholder="Date" id="date" value="<?php echo date('Y-m-d');?>">
                    Prix Total de la Commande<input name="prix" placeholder="Prix Total" id="prix" value="<?php echo $prix_total;?>">
