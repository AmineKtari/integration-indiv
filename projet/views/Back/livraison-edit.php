...
<head>
    ...
    <title>Modifier livraison | Kalthita</title>
    ...
    <?PHP
          ...
          include "../../core/livraisonC.php" ;
            ...
            $livraisonC=new livraisonC();
              $result=$livraisonC->recupererlivraison($_GET['ref']);
            foreach($result as $row){
              ...
              $etatdelivraison=$row['etatdelivraison'];
            }
          ?>
        ...
        <div class="single-product-tab-area mg-tb-15">
            ...
            <div class="single-pro-review-area">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        Id<input value="<?php echo $id ?>" name="id" type="text" class="form-control" placeholder="Id">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-pencil" aria-hidden="true"></i></span>
                                                        Mail<input value="<?php echo $mail ?>" name="mail" type="text" class="form-control" placeholder="Mail">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-usd" aria-hidden="true"></i></span>
                                                       Adresse<input value="<?php echo $adresse ?>" name="adresse" type="text" class="form-control" placeholder="Adresse">
                                                    </div>
                                                    
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-qrcode" aria-hidden="true"></i></span>
                                                        IDLivreur<input value="<?php echo $idlivreur ?>" name="idlivreur" type="text" class="form-control" placeholder="IDLivreur">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                       ...
                                                       Commande<input value="<?php echo $commande ?>" name="commande" type="text" class="form-control" placeholder="Commande">
                                                    </div>
                                                    
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-tag" aria-hidden="true"></i></span>
                                                        Etat de la Livraison<input value="<?php echo $etatdelivraison ?>" name="etatdelivraison" type="text" class="form-control" placeholder="Etat de la Livraison">
                                                    </div>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="text-center mg-b-pro-edt custom-pro-edt-ds">
                                                    <button name="modifier" type="submit" class="btn btn-primary waves-effect waves-light m-r-10">Modifier
                                                        ...
                                                        <input type="hidden" name="id_ini" value="<?php echo $_GET['ref'] ?>">
                ...
                if (isset($_POST['modifier'])){
                  $livraison=new livraison($_POST['id'],$_POST['mail'],$_POST['adresse'],$_POST['idlivreur'],$_POST['commande'],$_POST['etatdelivraison']);
