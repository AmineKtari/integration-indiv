...
<head>
    ...
    <title>Modifier Pack | Kalthita</title>
...
<body>
    <?PHP
          ...
          include "../../core/packC.php";
            ...
            $packC=new packC();
            $result=$packC->recupererPack($_GET['ref']);
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input value="<?php echo $Ref ?>" name="ref" type="text" class="form-control" placeholder="Réfèrence">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-pencil" aria-hidden="true"></i></span>
                                                        <input value="<?php echo $nom ?>" name="title" type="text" class="form-control" placeholder="Product Title">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-usd" aria-hidden="true"></i></span>
                                                        <input value="<?php echo $prix ?>" name="price" type="text" class="form-control" placeholder="Price">
                                                    </div>
                                                    
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-qrcode" aria-hidden="true"></i></span>
                                                        <input value="<?php echo $quantite ?>" name="qt" type="text" class="form-control" placeholder="Quantity">
                                                    </div>

                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-ticket" aria-hidden="true"></i></span>
                                                        <input value="<?php echo $description ?>" name="des" type="text" class="form-control" placeholder="Product Description">
                                                    </div>
...
?>
                                                            ...
                                                            <option value="<?php echo $row['Ref']; ?>" <?php if ($x == $row['Ref']) echo "selected";  ?> ><?php echo $row['Nom']; ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    </div>
                                                     <div class="input-group mg-b-pro-edt">
...
?>
                                                            ...
                                                            <option value="<?php echo $row['Ref']; ?>" <?php if ($y == $row['Ref']) echo "selected";  ?>><?php echo $row['Nom']; ?></option>
                                                            <?php } ?>
...
?>
                                                            ...
                                                            <option value="<?php echo $row['Ref']; ?>" <?php if ($z == $row['Ref']) echo "selected";  ?>><?php echo $row['Nom']; ?></option>
                                                            <?php } ?>
                                                        </select>
                ...
                if (isset($_POST['modifier'])){
                  $pack=new pack($_POST['ref'],$_POST['title'],$_POST['des'],$_POST['qt'],"",$_POST['price'],$_POST['x'],$_POST['y'],$_POST['z']);
                    $packC->modifierPack($pack,$_POST['ref_ini']);
