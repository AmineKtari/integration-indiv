...
<head>
    ...
    <title>Ajouter Produit | Kalthita</title>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                ...
                                <div id="myTabContent" class="tab-content custom-product-edit">
                                    <form name="form" method="post" action="ajouterProduit.php" enctype="multipart/form-data" onsubmit="return validateForm()">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input name="ref" type="text" class="form-control" placeholder="Réfèrence">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
