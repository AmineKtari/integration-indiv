    ...
    <?PHP
          ...
          include "../../core/LivreurC.php";
            ...
            $livreurC=new livreurC();
              $result=$livreurC->recupererLivreur($_GET['ref']);
                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                ...
                                <li><a title="Blog Details" href="livreur-edit.html"><i class="fa fa-pencil sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Editer un livreur</span></a></li>
                                ...
                                <li><a title="Blog Details" href="livraison-edit.html"><i class="fa fa-pencil sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Editer un livreur</span></a></li>
                            </ul>
                        </li>
                        <li>
        ...
        <div class="single-product-tab-area mg-tb-15">
            ...
            <div class="single-pro-review-area">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input value="<?php echo $cin ?>" name="a" type="text" class="form-control" placeholder="CIN">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-pencil" aria-hidden="true"></i></span>
                                                        <input value="<?php echo $nom ?>" name="nom" type="text" class="form-control" placeholder="Nom">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-usd" aria-hidden="true"></i></span>
                                                        <input value="<?php echo $prenom ?>" name="prenom" type="text" class="form-control" placeholder="Prenom">
                                                    </div>
                                                    
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-qrcode" aria-hidden="true"></i></span>
                                                        <input value="<?php echo $tel ?>" name="tel" type="text" class="form-control" placeholder="Téléphone">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input value="<?php echo $adresse ?>" name="b" type="text" class="form-control" placeholder="Adresse">
                                                    </div>
                                                    
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-tag" aria-hidden="true"></i></span>
                                                        <input value="<?php echo $vehicule ?>" name="c" type="text" class="form-control" placeholder="Véhicule">
                                                    </div>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="text-center mg-b-pro-edt custom-pro-edt-ds">
                                                    <button name="modifier" type="submit" class="btn btn-primary waves-effect waves-light m-r-10">Modifier
                                                        ...
                                                        <input type="hidden" name="cin_ini" value="<?php echo $_GET['ref'] ?>">
                ...
                if (isset($_POST['modifier'])){
                  $livreur=new livreur($_POST['a'],$_POST['nom'],$_POST['prenom'],$_POST['tel'],$_POST['b'],$_POST['c']);
