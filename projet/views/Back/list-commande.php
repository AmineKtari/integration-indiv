...
<head>
    ...
    <title>Liste des commandes | Kalthita</title>
                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="Inbox" href="list-commande.php"><i class="fa fa-list sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Liste des commandes</span></a></li>
                                <li><a title="View Mail" href="historique.php"><i class="fa fa-history sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Historique des commandes</span></a></li>
                            </ul>
                        </li>
                        <li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Liste des commandes</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                               ...
                               <?php
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $row['prixtotal']; ?> </td>
                                        ...
                                        <input type="hidden" value="<?php echo $row['num']; ?>" name="numS">
                            ...
                            {
                                $chart_data .= "{ id:'"."ID Client : ".$row["cinfk"]."',prix:'" .$row["prixtotal"]."',}, ";
                            }
                            ...
                            <div class="container" style="width:900px;">
                                <h2 align="center">Commandes Clients</h2>
                                <h3 align="center"></h3>
                                <br /><br />
                                <div id="chart"></div>
                            </div>
