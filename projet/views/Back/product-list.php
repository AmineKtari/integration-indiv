...
<head>
    ...
    <title>Liste des produits | Dashboard Kalthita</title>
                            ...
                            <table id="myTable">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $row['Categorie']; ?> </td>
                                     <td><img style="width :60px; height:60px" src="showimage.php?id=<?php echo $row['Ref']; ?>"> </td>
                                    
                                    <td><a href="product-edit.php?ref=<?php echo $row['Ref']; ?>">Modifier</a></td> 
                                      <td>  
