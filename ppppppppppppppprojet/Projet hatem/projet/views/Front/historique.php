...
$result=$Commande->afficherCommande_id_client($id_client);



    $to='fahd.larayedh@esprit.tn';
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 sav-info">
                ...
                <form method="POST" name="form" class="sav-form" action="product.php" enctype="multipart/form-data" onsubmit="return validateForm()">

                    <?php
                    foreach ($result as $key) {
                        ?>
                        <input type="text" name="num" placeholder="Numéro" id="num" value="<?php echo $key['num'];?>">
                        <input type="text" name="nom" placeholder="Nom" id="nom" value="<?php echo $key['date'];?>">
                        <input type="text" name="prenom" placeholder="Prénom" id="prenom" value="<?php echo $key['etat'];?>">
                        <input name="prix" placeholder="Prix Total" id="prix" value="<?php echo $key['prixtotal']; ?>">
                        <br><br>
                        <?php
                    }
                        ?>
