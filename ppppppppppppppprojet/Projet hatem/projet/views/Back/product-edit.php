...
<head>
    ...
    <title>Modifier Produit| Kalthita</title>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-tag" aria-hidden="true"></i></span>
                                                        <input value="<?php echo $categorie ?>" name="cat" type="text" class="form-control" placeholder="Category">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-tag" aria-hidden="true"></i></span>
...
{
                  $produit=new produit($_POST['ref'],$_POST['title'],$_POST['price'],$_POST['qt'],$_POST['des'],$_POST['cat'],"");
