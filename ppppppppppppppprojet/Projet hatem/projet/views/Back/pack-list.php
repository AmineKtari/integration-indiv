...
$pack1C=new packC();
$listePacks=$pack1C->afficherPack();
...
<head>
    ...
    <title>Liste des packs | Dashboard Kalthita</title>
                        ...
                        <div class="product-status-wrap">
                            ...
                            <table id="myTable">
                                <tr>
                                    ...
                                    <th onclick="sortTable(4)">Produit 1</th>
                                    <th onclick="sortTable(5)">Produit 2</th>
                                    <th onclick="sortTable(6)">Produit 3</th>
                               ...
                               $produitC=new produitC();
                                ...
                                foreach ($listePacks as $row ) {
                                    $liste=$produitC->recupererProduit1($row['x']);
                               $liste2=$produitC->recupererProduit1($row['y']);
                                $liste3=$produitC->recupererProduit1($row['z']);
                                ?>                                    
                                <tr>
                                    ...
                                    <td><?php foreach ($liste as $l) echo $l[0]; ?> </td>
                                    <td><?php foreach ($liste2 as $l) echo $l[0]; ?> </td>
                                    <td><?php foreach ($liste3 as $l) echo $l[0]; ?> </td>
                                    
                                    
                                    <td><a href="pack-edit.php?ref=<?php echo $row['ref']; ?>">Modifier</a></td> 
                                      <td>  
                                        
                                        <form method="POST" action="supprimer_pack.php"> 
                                        <input type="hidden" value="<?php echo $row['ref']; ?>" name="refS">
